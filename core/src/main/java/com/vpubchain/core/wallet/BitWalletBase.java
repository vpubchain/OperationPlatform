...
import static com.vpubchain.core.util.BitAddressUtils.isP2SHAddress;
...
//        checkAddress(destination);
     ...
     * <p>给定一个包含事务的发送请求，尝试对其输入进行签名。此方法需要事务
     *
     * *连接所有必要的输入，否则将忽略这些输入。<p>
     *
     * *<p>实际签名是由pluggable@link org.bitcoinj.signers.localtransactionsigner完成的。
     *
     * *而且不能保证交易最终会完成。<p>
     *
     */
