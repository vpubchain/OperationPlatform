package com.vpubchain.stratumj;

import com.vpubchain.stratumj.messages.BaseMessage;
import com.vpubchain.stratumj.messages.CallMessage;
import com.vpubchain.stratumj.messages.MessageException;
    ...
    private class MessageHandler implements Runnable {
        ...
        private void handle(BaseMessage message) {
            if (message instanceof ResultMessage) {
                ...
                log.error("callmessage"+reply.getMethod());
    ...
    protected void run() {
        ...
        while (isRunning() && isConnected()) {
            try {
                ...
                log.error("getmessage"+ serverMessage);
            } catch (IOException e) {
                if (isRunning()) {
...
//                }
    ...
    public ListenableFuture<ResultMessage> call(CallMessage message) {
        ...
        try {
            log.error("SendCall"+message.toString());
