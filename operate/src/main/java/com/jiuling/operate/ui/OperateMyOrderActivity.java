...
import com.jiuling.operate.di.component.DaggerOperateMyOrderComponent;
...
public class OperateMyOrderActivity extends BaseOperateActivity<OperateMyOrderActivityPresenter> implements IOperateMyOrderActivityView {
    ...
    protected void setupAcitivtyComponent(ApplicationComponent applicationComponent) {
        DaggerOperateMyOrderComponent.builder().applicationComponent(applicationComponent).operateMyOrderModule(new OperateMyOrderModule(this)).build().injectOperateMyOrderActivity(this);
    }
    ...
    protected void initView() {
        ...
        nodeAdapter = new ViewPagerAdapter(getSupportFragmentManager(),2);
