...
import com.jiuling.commonbusiness.base.BaseActivity;


/**
 * Created by Administrator on 2017/11/24.
 */
public abstract class ShowPopUtilForBaseActivity {
    ...
    public ShowPopUtilForBaseActivity(int layout, Activity activity){
        this.layout=layout;
        this.activity=activity;
    }

    public ShowPopUtilForBaseActivity(int layout, Activity activity, double width, double height, boolean isBottom){
        this.layout=layout;
        this.activity=activity;
        this.width=width;
        this.height=height;
    ...
    public ShowPopUtilForBaseActivity(int layout, Activity activity, double width, double height){
        this.layout=layout;
        this.activity=activity;
        this.width=width;
        this.height=height;
...
//            mPop.setAnimationStyle(R.style.TranslationPopupWindowAnimation);
            if (width!=0){
                mPop.setWidth((int) (BaseActivity.mScreenWidth * width));
            }
            if (height!=0){
                mPop.setHeight((int) (BaseActivity.mScreenHeight * height));
            }
