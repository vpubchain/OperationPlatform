...
import com.jiuling.commonbusiness.base.baseRecycler.creator.RefreshViewCreator;
...
public class RefreshRecyclerView extends WrapRecyclerView {
     ...
     * 设置某个view的marginTop
     */
    public void setViewMarginTop(int marginTop,View view) {
        ViewGroup.MarginLayoutParams params = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
        params.bottomMargin = marginTop;
