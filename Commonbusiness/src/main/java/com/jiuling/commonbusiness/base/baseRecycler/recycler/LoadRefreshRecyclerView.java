package com.jiuling.commonbusiness.base.baseRecycler.recycler;
...
import com.jiuling.commonbusiness.base.baseRecycler.creator.LoadViewCreator;
...
public class LoadRefreshRecyclerView extends RefreshRecyclerView {
    ...
    private void restoreLoadView() {
        ...
        if (mCurrentLoadStatus == LOAD_STATUS_LOOSEN_LOADING) {
            ...
            mLoadCreator.noLoadingAndActionUp();
        }
...
//                    setRefreshViewMarginBottom(mLoadViewHeight   + 1);
                }
            }
    }
     ...
     * 设置刷新View的marginTop
     */
    private void setRefreshViewMarginBottom(int marginBottom) {
        ViewGroup.MarginLayoutParams params = (ViewGroup.MarginLayoutParams) mLoadView.getLayoutParams();
