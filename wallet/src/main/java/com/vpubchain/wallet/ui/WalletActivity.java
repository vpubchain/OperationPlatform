...
import com.vpubchain.core.uri.CoinURI;
import com.vpubchain.core.uri.CoinURIParseException;
import com.vpubchain.core.util.GenericUtils;
import com.vpubchain.core.wallet.AbstractAddress;
import com.vpubchain.core.wallet.SerializedKey;
import com.vpubchain.core.wallet.WalletAccount;
import com.vpubchain.wallet.Constants;
import com.vpubchain.wallet.R;
import com.vpubchain.wallet.service.CoinService;
import com.vpubchain.wallet.service.CoinServiceImpl;
import com.vpubchain.wallet.tasks.CheckUpdateTask;
import com.vpubchain.wallet.ui.dialogs.TermsOfUseDialog;
import com.vpubchain.wallet.util.SystemUtils;
...
import static com.vpubchain.wallet.ui.NavDrawerItemType.ITEM_COIN;
import static com.vpubchain.wallet.ui.NavDrawerItemType.ITEM_OVERVIEW;
import static com.vpubchain.wallet.ui.NavDrawerItemType.ITEM_SECTION_TITLE;
...
//                    BigInteger integer = web3j.ethGetBalance("0x119b6143E10a1f85EE2ebFd47f14f201DaaF3c90", DefaultBlockParameterName.LATEST).send().getBalance();
//                    //格式化位数
////                    web3j.ethGetTran
////                    rx.Observable<EthBlock> ethBlockObservable = web3j.blockObservable(false);
////                    ethBlockObservable.subscribe(new Observer<EthBlock>() {
////                        @Override
...
////                            Log.i("banlance",e.getMessage());
////                        }
////
////                        @Override
////                        public void onNext(EthBlock ethBlock) {
////                            Log.i("banlance",ethBlock.toString());
////                        }
////                    });
//
//
...
//            }
    ...
    private boolean startOperate() {

        Intent intent = new Intent();
        intent.setClass(this,OperateMainActivity.class);
...
//        NavDrawerItem.addItem(navDrawerItems, ITEM_OVERVIEW, getString(R.string.title_activity_overview), R.drawable.ic_launcher, null);
    ...
    protected void onResume() {
        ...
        //大project
        //开启 CoinServiceImpl 服务  startService(coinServiceCancelCoinsReceivedIntent);
